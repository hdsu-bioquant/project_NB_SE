...
params:
  ...
  path_high_bed: "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/superNB/src/project_NB_SE/scripts/figure3/figure3_IGV_highlight_ranges.bed"
  ...
  MES_activity : "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/superNB/analysis/tumor/VIPER/MES_TFactivity.RDS"
  width_window : 2000
  chr   : "chr11"
  start : 68776977
  end   : 69667477
  name  : "CCND1"
  figure: "results/figures_revision/figureMNA-HR_MNA-LR_IGV.pdf"
  width : 11
  height: 6
  summbw : "sumbw"
editor_options: 
...
"/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/superNB/analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_K3_Hmatrix_hnorm.RDS"
...
tumor_mnalr <- tumor_sig_assign == "MNA-LR"
tumor_mnahr <- tumor_sig_assign == "MNA-HR"
# tumor_mnalr <- assign_signature(tumor_h)["MNA-LR",]
# tumor_mnahr <- assign_signature(tumor_h)["MNA-HR",]
...
tracksIDs <- c("MNA-LR H3K27ac tumors",
               "Tumor SE",
               "MNA-HR H3K27ac tumors")
...
bind_rows(
  ...
  ##––––––––––––––––––––––––––––––––––––––––––––––––––––##
  ##              MNA-LR H3K27ac tumors                 ##
  ##––––––––––––––––––––––––––––––––––––––––––––––––––––##
  data.frame(sampleID = names(tumor_mnalr)[tumor_mnalr],
             type	    = "tumor",
             scale    = "type",
             class    = params$summbw,
             color    = "#00afaf",
             trackID  = "MNA-LR H3K27ac tumors",
             labels	  = TRUE,
             height   = 3,
             path     = paste0("data/tumor/chipseq/H3K27ac/bw/", names(tumor_mnalr)[tumor_mnalr], "_H3K27ac.bw"), 
  ...
  ##              MNA-HR H3K27ac tumors                 ##
  ##––––––––––––––––––––––––––––––––––––––––––––––––––––##
  data.frame(sampleID = names(tumor_mnahr)[tumor_mnahr],
             type	    = "tumor",
             scale    = "type",
             class    = params$summbw,
             color    = "firebrick",
             trackID  = "MNA-HR H3K27ac tumors",
             labels	  = TRUE,
             height   = 3,
             path     = paste0("data/tumor/chipseq/H3K27ac/bw/", names(tumor_mnahr)[tumor_mnahr], "_H3K27ac.bw"), 
             stringsAsFactors = FALSE)
...
read_sumBW <- function(config, region2plot, ...){
  ...
  span <- 0.01
  n    <- 700
  d <- apply(as.matrix(dsD[,2:5]), 2, function(y){
