...
dim(gene_exprs)
hsapiens_genes  <- hsapiens_genes[hsapiens_genes$gene_id %in% rownames(gene_exprs)]
...
saveRDS(SE_annot_df, "analysis/tumor/SE_annot/tumor_consensusSE_target_annotation_df.RDS")
```
...
saveRDS(SE_target_rank, "analysis/tumor/SE_annot/tumor_consensusSE_target_rank_list.RDS")
...
saveRDS(SE_target, file="analysis/tumor/SE_annot/tumor_consensusSE_target_GRanges.RDS")

write.table(SE_target, "analysis/tumor/SE_annot/tumor_consensusSE_target_GRanges.bed",
