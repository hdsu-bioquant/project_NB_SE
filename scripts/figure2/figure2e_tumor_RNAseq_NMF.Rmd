---
title: "Figure 2e - Tumor SE Target RNAseq NMF"
...
params:
  ...
  norm_nmfW : "analysis/tumor/rnaseq/NMF/tumor_consensusSE_targetExprs_normNMF_W.RDS"
  norm_nmfH : "analysis/tumor/rnaseq/NMF/tumor_consensusSE_targetExprs_normNMF_H.RDS"
  hmatrix_wnorm : "path/to/..."
  wmatrix_wnorm : "path/to/..."
  nmf_features  : "path/to/..."
  hmatrix_hnorm : "analysis/tumor/rnaseq/NMF/tumor_consensusSE_K4_Hmatrix_hnorm.RDS"
  figure2e      : "results/figures/figure2/..."
editor_options: 
...
##––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––##
rec_gsub <- recovery_annot(hmatrix, annot, "GenomicSubtype")
signature_idx$`MNA-LR` <- which(rec_gsub$A$p < 0.05 & rec_gsub$A$z > 0)
signature_idx$`MNA-HR` <- which(rec_gsub$D$p < 0.05 & rec_gsub$D$z > 0)
signature_idx
...
norm.nmf.hmatrix <- readRDS("analysis/tumor/rnaseq/NMF/tumor_consensusSE_K4_Hmatrix_wnorm.RDS")
# read annotation 
...
type.colVector <- list(#Type    = c("Tumor"="grey80", "Metastasis"="grey60", "NA"="white"),
                       ...
                       # Risk     = c("HR"="grey20", "IR"="grey50", "LR"="grey80",
                       #              "LR/IR"="grey65", "NA"="white"),
...
#pdf(file = params$figure2e, width=10, height=7)
pdf(file = "results/figure2/figure2e_tumor_RNAseq_hmatrix.pdf", width=10, height=7)
#print(h.heatmap)
#draw(h.heatmap)
h.heatmap
dev.off()
