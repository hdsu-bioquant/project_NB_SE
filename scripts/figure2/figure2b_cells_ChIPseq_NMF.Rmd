...
params:
  ...
  norm_nmfW : "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_SignalScore_normNMF_W.RDS"
  norm_nmfH : "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_SignalScore_normNMF_H.RDS"
  hmatrix_wnorm : "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_K4_Hmatrix_wnorm.RDS"
  wmatrix_wnorm : "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_K4_Wmatrix_Wnorm.RDS"
  nmf_features  : "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_K4_NMF_features.RDS"
  hmatrix_hnorm : "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_K4_Hmatrix_hnorm.RDS"
  figure2b      : "results/figures/figure2/figure2b_cells_SE_hmatrix.pdf"
editor_options: 
...
#                nmf_features  = "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_K4_NMF_features.RDS",
#                hmatrix_hnorm = "analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_K4_Hmatrix_hnorm.RDS",
#                figure2a      = "results/figures/figure2/figure2b_cells_SE_hmatrix.pdf")
...
##––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––##
signature_idx$MNA <- which(rec_MYCN$Amp$z < 0 & rec_MYCN$NonAmp$z > 0 & rec_MYCN$Amp$p > 0.05)
signature_idx$MNA
##––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––##
...
pdf(file = params$figure2b, width=10, height=7)
#print(h.heatmap)
#draw(h.heatmap)
h.heatmap
dev.off()
