...
params:
  nmf_tumor     : "path/to/data"
  nmf_cells     : "path/to/data"
...
# params <- list(annot_tumor = "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/publication_GEO/annotation/annotation_tumor.RDS",
#                annot_cells = "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/publication_GEO/annotation/annotation_cells.RDS",
#                nmf_tumor   = "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/publication_GEO/analysis/tumor/chipseq/H3K27ac/NMF/tumor_consensusSE_SignalScore_normNMF_W.RDS",
#                nmf_cells   = "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/publication_GEO/analysis/cells/chipseq/H3K27ac/NMF/cells_consensusSE_SignalScore_normNMF_W.RDS")
...
col_vector=c(col.inf[1], col.vir[1], 
             col.vir[2], col.pla[1], col.inf[2], 
             col.pla[2], col.pla[2], col.inf[3], col.vir[3], 
             col.inf[4], col.pla[3], col.vir[4], col.mag[2], col.pla[3],
             col.pla[5], col.inf[5], col.mag[3], col.inf[5], col.pla[5], col.vir[5])
...
col_vector=c(col.inf[1], col.pla[1], 
             col.vir[2], col.inf[2], col.pla[2], 
             col.mag[1], col.inf[3], col.vir[3], col.pla[3], 
             col.pla[4], col.vir[4], col.pla[4], col.inf[4], col.mag[2], 
             col.pla[5], col.vir[5], col.pla[5], col.mag[3], col.inf[5], col.mag[3])
