...
params:
  ...
  figure: "results/figure3/Enhancer_Comparison_using_HiChIP.pdf"
editor_options: 
...
```{r DIFFBIND, message=FALSE, warning=FALSE, cache=T}
##––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––––##
...
samples[samples$SampleID %in% mes_sampleIDs,]$Condition <- "mesenchymal"
...
Emc   <- d.db[which(d.db@elementMetadata$Fold < 0),]
Enm   <- d.db[which(d.db@elementMetadata$Fold > 0),]
...
Enone@elementMetadata$'Conc_non mesenchymal' <- 0
Enone@elementMetadata$Conc_mesenchymal <- 0
