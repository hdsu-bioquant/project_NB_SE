...
params:
  ...
  path_high_bed: "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/publication_GEO/src/project_NB_SE/scripts/figure3/figure3_IGV_highlight_ranges.bed"
  ...
  MES_activity : "/icgc/dkfzlsdf/analysis/B080/crg/B087_Neuroblastoma/publication_GEO/analysis/tumor/VIPER/MES_TFactivity.RDS"
  width_window : 2000
  chr   : "chr11"
  start : 68776977
  end   : 69667477
...
tf_activity <- data.frame(Activity.Mes = MES_activity, 
                          row.names    = names(MES_activity) )
...
plot_tracks_from_config(tracks_config, roi, width_window = params$width_window)
