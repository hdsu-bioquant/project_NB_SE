...
write_xlsx(list(`Extended Data figure 9c` = gg_ras$projection,
                `Extended Data figure 9c bar` = gg_ras$barplot,
                `Extended Data figure 9c expr` = gg_ras$exprs), 
           path = "results/figure_source_data/Extended_Data_figure_9c.xlsx")
write_xlsx(list(`Extended Data figure 9d` = gg_junfos$projection,
                `Extended Data figure 9d bar` = gg_junfos$barplot,
                `Extended Data figure 9d expr` = gg_junfos$exprs), 
